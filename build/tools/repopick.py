...
if __name__ == '__main__':
    # Default to CatalystOS Gerrit
    default_gerrit = 'https://review.catalystos.net'
    ...
    for project in projects:
        name = ("CatalystOS/")+project.get('name')
    ...
    for item in mergables:
        ...
        if args.gerrit == default_gerrit:
            ...
            if args.pull:
                cmd = ['git pull --no-edit catalyst', item['fetch'][method]['ref']]
            else:
                cmd = ['git fetch catalyst', item['fetch'][method]['ref']]
            if args.quiet:
                cmd.append('--quiet')
            else:
                print(cmd)
