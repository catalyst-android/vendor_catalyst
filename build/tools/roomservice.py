...
custom_default_revision = "catalyst-13.0"
custom_dependencies = "catalyst.dependencies"
org_manifest = "CatalystOS-Devices"  # leave empty if org is provided in manifest
org_display = "CatalystOS-Devices"  # needed for displaying

catalyst_manifest = ".repo/manifests/catalyst.xml"
...
def add_to_manifest(repos, fallback_branch=None):
    ...
    catalystm = load_manifest(catalyst_manifest)
    ...
    for repo in repos:
        ...
        elif exists_in_tree(catalystm, repo_target) != None:
            existing_m_project = exists_in_tree(catalystm, repo_target)
