...
# Copyright (C) 2018-2021 CatalystOS
#
...
PRODUCT_COPY_FILES += \
    $(call find-copy-subdir-files,*,vendor/catalyst/sounds/pixel/,$(TARGET_COPY_OUT_PRODUCT)/media/audio)

# 2019 Material product sounds (CC-BY 4.0)
# Source: https://material.io/design/sound/sound-resources.html
PRODUCT_COPY_FILES += \
    $(call find-copy-subdir-files,*,vendor/catalyst/sounds/material/,$(TARGET_COPY_OUT_PRODUCT)/media/audio)
